...
<head>
   ...
   {{ HTML::style('admin/css/bootstrap-cerulean.min.css') }}

   {{ HTML::style('admin/css/charisma-app.css')}}
    {{ HTML::style('admin/bower_components/fullcalendar/dist/fullcalendar.css') }}
{{ HTML::style('admin/bower_components/fullcalendar/dist/fullcalendar.print.css') }}
