...
return [
    ...
    */
    ...
    | failed admin attempts across your site and can limit the effects of an
    | attempted DDoS attack.
    |
    | The second type is "ip". This allows you to throttle the failed admin
    | attempts (across any account) of a given IP address.
    |
    | The third type is "user". This allows you to throttle the admin attempts
    ...
    | of failed admin attempts, and the value is the delay, in seconds, before
    | the next attempt can occur.
    |
    | The second way is by providing an integer. If the number of failed admin
    | attempts outweigh the thresholds integer, that throttle is locked until
    | there are no more failed admin attempts within the specified interval.
    |
